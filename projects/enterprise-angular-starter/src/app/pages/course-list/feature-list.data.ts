...
export const features: Feature[] = [
  {
    ...
    description: 'yea.features.angular',
  ...
  },
  {
    ...
    description: 'yea.features.angular-material',
  ...
  },
  {
    ...
    description: 'yea.features.angular-cli',
  ...
  },
  {
    ...
    description: 'yea.features.bootstrap',
  ...
  },
  {
    ...
    description: 'yea.features.typescript',
  ...
  },
  {
    ...
    description: 'yea.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'yea.features.fontawesome',
  ...
  },
  {
    ...
    description: 'yea.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'yea.features.themes.title',
    description: 'yea.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'yea.features.lazyloading.title',
    description: 'yea.features.lazyloading.description',
    documentation:
